...
//            mObject.parse(body.string());
            ...
            } else if (mObject instanceof NetLoginObj) {
                mObject.parse(AssetUtils.readFile("login_data"));
            } else if (mObject instanceof NetNotifyMsgObj) {
                mObject.parse(AssetUtils.readFile("appnotifymsg.txt"));
            }
            // ...
